...
var myBott = ["u49f93172b8c8865683dd2d47ccbb8613","u6a5b943a40eaba3be7e4bd48d0b43d79","u7b31658bfbf9e54ba91c3c4779761f66","ue805c138c850e424c5c44f2fb2f602db","uc6dc5377de435afff46d804a4a0a29db"];//TARO MID LU DISINI SUPAYA BISA PKE COMMAND STAFF

const myBot = ["u49f93172b8c8865683dd2d47ccbb8613","u6a5b943a40eaba3be7e4bd48d0b43d79","u7b31658bfbf9e54ba91c3c4779761f66","ue805c138c850e424c5c44f2fb2f602db","uc6dc5377de435afff46d804a4a0a29db"];//TARO MID LU DISINI
...
let { listMember } = await this.searchGroup(seq.to);
     const mentions = await this.mention(listMember);
        ...
        if(txt === 'lari' && this.stateStatus.kick == 1 && isStaffOrBot(seq.from)) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        if(txt == 'intip') {
            this._sendMessage(seq, `Cek Tukang Ngintip`);
        ...
        if(txt == 'set cctv') {
            ...
            this.checkReader = []
            this._sendMessage(seq, `Menghapus Data Tukang Ngintip`);
        }  
        ...
        if(txt == 'creator bot') {
           this._sendMessage(seq, 'My Creator Is Bee\nId Line : http://line.me/ti/p/~mrtwopay\n\n-TWOPAY BOT-');
           seq.contentType=13;
           seq.contentMetadata = { mid: 'u49f93172b8c8865683dd2d47ccbb8613' };
           this._client.sendMessage(1, seq);
        }
        ...
        if(cmd == 'spam' && isStaffOrBot(seq.from)) {
            for(var i= 0; i < 10;  i++) {
               this._sendMessage(seq, 'I Love You~');
        }
    }
        ...
        if(txt == 'balik') {
           if(isAdminOrBot(seq.from) || isStaffOrBot(seq.from)){
          let txt = await this._sendMessage(seq, 'Kami Dari TWOPAY BOT Terima Kasih Atas Groupnya Dan Kami Izin Leave~');
